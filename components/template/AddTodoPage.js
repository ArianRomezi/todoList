...
const AddTodoPage = () => {
    const addHandler= async () => {
        const res=await fetch("/api/todos",{method:"POST",body:JSON.stringify({title,status}),headers:{"Content-Type":"aplication/json"},});
        ...
        <div className="add-form">
            ...
            <div className='add-form__input'>
                ...
                <div className='add-form__input--second'>
                    ...
                    <RadioButton status={status} setStatus={setStatus} value="inProgres" title="in progress">
                        <FiSettings/>
                    </RadioButton>
